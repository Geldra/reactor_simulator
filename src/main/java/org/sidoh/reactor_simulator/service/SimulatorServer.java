...
public class SimulatorServer {
  ...
  public static final int MAX_NUMBER_OF_TICKS = 1000000;
  ...
  public static void validateReactorDefinition(ReactorDefinition reactorDefinition) {
    ...
    checkArgument(reactorDefinition.getxSize() <= 666, "xSize should be no larger than 666");
    checkArgument(reactorDefinition.getzSize() <= 666, "zSize should be no larger than 666");
    checkArgument(reactorDefinition.getHeight() <= 256, "height should be no larger than 256");
